            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input id="file_input" required type="file" accept=".jpg,.jpeg,.png" class="form-control blue-border" data-testid="file" />
                    <div data-testid="error-file" class="error-file"></div>
                  </div>
                </div>
            </div>
            <div class="row">
